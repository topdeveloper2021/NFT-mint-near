...
export default function Terms() {
  return (
    <Container>
      <HeadingText>Nearnaut Terms and Conditions</HeadingText>
      <p className="intro">These “Terms and Conditions” last material update was made on: 20th May, 2021.</p>
      <p className="intro">
        Nearnaut allows you to participate, by creating, displaying, buying and selling
        non-fungible tokens (“NFTs”) and is made available to you by Nearnaut.
      </p>
      <ol>
        <li className="point">

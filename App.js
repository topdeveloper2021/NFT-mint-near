...
import  disBG  from '~/assets/images/BG1.png';
    ...
    <QueryClientProvider client={queryClient}>
      ...
      <ErrorBoundary FallbackComponent={ErrorFallback}>
        <div className="app">
          ...
          <Router>
            <Navigation />
            <div className="content"  style={{backgroundImage:`url("${disBG}")`}}>
              <Switch>
                ...
                <UserPage
                  path="/rank"
                  component={RankCheck}
                  title="Check Rank of a Naut"
                  isAuthenticated={isAuthenticated}
                  isLoading={isLoading}
                />
                <Page path="/rankcheck" component={Marketplace} title="Marketplace" />
                ...
                <Page path="/nautview" component={Market} title="Market" />
                <UserPage
                  exact
                  path="/profile"
                  component={Profile}
